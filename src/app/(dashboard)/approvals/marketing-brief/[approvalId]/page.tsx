...
export default function MarketingBriefApprovalPage() {
  ...
  // Redirect if this is not a marketing_brief approval
  useEffect(() => {
  ...
  if (isLoading) {
    return (
      <Container maxWidth="lg" sx={{ py: 4, textAlign: 'center' }}>
        <CircularProgress />
        <Typography sx={{ mt: 2 }}>Loading Marketing Brief approval...</Typography>
      </Container>
    )
  }
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      {/* Content - Marketing Brief Editor */}
      <Card sx={{ mb: 3 }}>
            ...
            <AccordionDetails>
              <Box>
                ...
                {!editedData && (
                  <Box sx={{ mt: 2 }}>
                    <MarkdownSection
                      content={formatApprovalOutput(approval.output_data, approval.pipeline_step || 'marketing_brief')}
                    />
                  </Box>
                )}
              </Box>
